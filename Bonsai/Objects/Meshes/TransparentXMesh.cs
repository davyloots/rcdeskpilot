...
namespace Bonsai.Objects.Meshes
{
    ...
    public sealed class TransparentXMesh : MeshBase, IDisposable
    {
        ...
        public TransparentXMesh(string name)
        {
            meshFileName = name;
            Create(Framework.Instance.Device, meshFileName);
        }
        /// <summary>Create a new mesh</summary>
        public TransparentXMesh() : this("FrameworkMeshFile_Mesh") { }
        ...
        {
            Framework.Instance.Device.DeviceLost -= new EventHandler(OnLostDevice);
            Framework.Instance.Device.DeviceReset -= new EventHandler(OnResetDevice);
            Framework.Instance.Device.Disposing -= new EventHandler(OnDeviceDisposing);
