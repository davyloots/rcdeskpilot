...
namespace Bonsai.Core.Dialogs
{
    ...
    public class SettingsDialog : DialogBase
    {
        ...
        public SettingsDialog(Framework sample) : base(sample)
        {
            CreateControls();
        }
        #endregion
        ...
        private ComboBox textureFilterCombo;
        // Check boxes
        ...
        private void CreateControls()
        {
            ...
            // Texture Filter
            dialog.AddStatic((int)SettingsDialogControlIds.Static, "Texture Filtering", 10, 415, 180, 23);
            textureFilterCombo = dialog.AddComboBox((int)SettingsDialogControlIds.TextureFilter, 200, 415, 300, 23);
        ...
        /// </summary>
        public override void OnCreateDevice(Device d)
        {
            ...
            textureFilterCombo.Changed += new EventHandler(OnTextureFilterChanged);
        }
        ...
        public override void OnDestroyDevice(object sender, System.EventArgs e)
        {
            // Clear the focus
            Dialog.ClearFocus();
        ...
        private void OnRefreshRateChanged(object sender, System.EventArgs e)
        {
        ...
        private void OnMultisampleQualityChanged(object sender, System.EventArgs e)
        {
            ComboBox cb = sender as ComboBox;
        ...
        private void OnVertexProcessingChanged(object sender, System.EventArgs e)
        {
            ComboBox cb = sender as ComboBox;
        ...
        private void OnPresentIntervalChanged(object sender, System.EventArgs e)
        {
            ComboBox cb = sender as ComboBox;
        ...
        private void OnClipWindowChanged(object sender, System.EventArgs e)
        {
        ...
        void OnTextureFilterChanged(object sender, System.EventArgs e)
        {
            ComboBox cb = sender as ComboBox;
            globalSettings.TextureFilter = (TextureFilter)cb.GetSelectedData();
            parent.State.CurrentDeviceSettings.TextureFilter = (TextureFilter)cb.GetSelectedData();
            parent.DeviceSettings.TextureFilter = (TextureFilter)cb.GetSelectedData();
        }
        /// <summary>Called when the fullscreen or windowed item changes</summary>
        private void OnWindowedFullscreenChanged(object sender, System.EventArgs e)
        {
            bool isWindowed = windowedButton.IsChecked;
            ...
            OnAdapterFormatChange(adapterFormatCombo, System.EventArgs.Empty);
            ...
            // Resolution changed
            OnResolutionChanged(resolution, System.EventArgs.Empty);
            ...
            OnRefreshRateChanged(refreshCombo, System.EventArgs.Empty);
        }
